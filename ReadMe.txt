...
res\Toolbar.bmp
    ...
    リソースエディタで編集し、Clock.rc ファイル内の IDR_MAINFRAME TOOLBAR 配列を
    変更してください。
/////////////////////////////////////////////////////////////////////////////
...
ClockDoc.h, ClockDoc.cpp - ドキュメント
    これらのファイルは CClockDoc クラスを含みます。特別なドキュメント デ
    ータを付け加えたり、CClockDoc::Serialize を使ったファイルのセーブや
    ロード機能をインプリメントしたいときはこのファイルを編集してください。

ClockView.h, ClockView.cpp - ビュー
    これらのファイルは CClockView クラスを含みます。
    CClockView オブジェクトは CClockDoc オブジェクトを表示するために
    使います。
res\ClockDoc.ico
    このファイルは CClockDoc クラスの MDI 子ウィンドウ用アイコンとして使
    われるアイコンファイルです。このアイコンはリソースファイル Clock.rc
    によってインクルードされます。
